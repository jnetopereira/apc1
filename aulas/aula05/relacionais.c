...
int main () {
  ...
  printf("o primeiro numero eh menor que o segundo numero? %i\n", eh_menor);

  int eh_maior_igual = numero1 >= numero2;
  printf("o primeiro numero eh maior ou igual ao numero 2? %i\n", eh_maior_igual);
  
  int eh_menor_igual = numero1 <= numero2;
  printf("o primeiro numero eh menor ou igual ao numero 2? %i\n", eh_menor_igual);
